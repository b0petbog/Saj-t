...
{
    public partial class DogFoodViewModel : BaseViewModel
    {
        private readonly DogFoodRepo _foodRepo = new();
        ...
        public DogFoodViewModel()
        {
            _selectedFood = new Food();
            UpdateView();
            StatusBarText = $"{NumberOfFoods} féle kutya eleség betöltve";
        }
